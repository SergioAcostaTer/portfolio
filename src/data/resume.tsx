    ...
    projects: [
        {
            ...
            active: true,
            description:
                "A production-grade, AI-augmented cloud storage platform that transforms raw files into an intelligent knowledge system. Built with enterprise-ready architecture featuring OAuth2/JWT authentication, event-driven processing, hybrid semantic search, and RAG-powered AI chat. Supports large-file uploads with multipart resume, automatic taxonomy generation, content summarization, and comprehensive SaaS billing via Stripe. The platform scales through containerized microservices, Redis caching, rate limiting, and full audit trails.",
            technologies: [
                "Java 21",
                "Spring Boot 3.4",
                "PostgreSQL 16",
